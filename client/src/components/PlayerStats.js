...
export const PlayrStats = () => {
  ...
  return (
    <div>
      <p className="font-bold uppercase text-4xl pb-3 flex relative before:absolute before:top-5 before:content-[''] before:w-72 before:h-6 before:bg-primary/20 before:rounded-md">
        Players stats
      </p>
